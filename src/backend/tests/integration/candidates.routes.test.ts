...
describe('candidates routes integration', () => {
  ...
  it('lists candidates for election', async () => {
    ...
    const body = response.body as CandidateRouteResponse;
  ...
  it('creates candidate with ADMIN token', async () => {
    const adminToken = generateAccessToken({
      sub: 'f8584eb5-f35d-4148-a8fe-97e6122ec112',
      codigo: 'ADMIN001',
      perfil: 'ADMIN',
      purpose: 'ACCESS',
    });
  ...
  it('approves candidate with GESTOR_ELEITORAL token', async () => {
    ...
    const response = await request(app)
      .patch(
        '/api/v1/elections/7163d892-e5c1-4fb2-bd70-7aa0349e61a7/candidates/0a25ef0f-3e31-4f17-bb9b-a2f27dc79ebf/approve',
      )
      .set('Authorization', `Bearer ${gestorToken}`);
    const body = response.body as CandidateRouteResponse;
  ...
  it('rejects candidate with GESTOR_ELEITORAL token', async () => {
    ...
    const response = await request(app)
      .patch(
        '/api/v1/elections/7163d892-e5c1-4fb2-bd70-7aa0349e61a7/candidates/0a25ef0f-3e31-4f17-bb9b-a2f27dc79ebf/reject',
      )
      .set('Authorization', `Bearer ${gestorToken}`);
    const body = response.body as CandidateRouteResponse;
  ...
  it('suspends candidate with GESTOR_ELEITORAL token', async () => {
    ...
    const response = await request(app)
      .patch(
        '/api/v1/elections/7163d892-e5c1-4fb2-bd70-7aa0349e61a7/candidates/0a25ef0f-3e31-4f17-bb9b-a2f27dc79ebf/suspend',
      )
      .set('Authorization', `Bearer ${gestorToken}`);
    const body = response.body as CandidateRouteResponse;
