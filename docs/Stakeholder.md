...
| **Comissão Eleitoral da AEUP** | Configurar as regras da eleição, gerir candidatos, definir o calendário eleitoral e exportar resultados em um arquivo pdf/excel. |
...
## Stakeholders Secundários (Afectados Indiretamente)

| Stakeholder | Interesse no Sistema |
|---|---|
| **Equipa de TI da UP-Maputo** | Assegurar o suporte técnico, a manutenção da plataforma SVOUP e a resolução de eventuais incidentes em contexto real de operação. |
