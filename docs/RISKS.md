...
| R03 | Erros no sistema que permitam votos duplicados               | Médio         | Alto    | Alta       | Implementar validação de voto único • Testes de sistema antes da eleição • Registo de votos no sistema      |
